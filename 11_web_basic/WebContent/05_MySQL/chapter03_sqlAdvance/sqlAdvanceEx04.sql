...
# 20대의 평균 렌트일 조회하기.
SELECT MEMBER_ID FROM MEMBER WHERE AGE BETWEEN 20 AND 29;
...
# 30대 여성의 평균 렌트일 조회하기.
SELECT MEMBER_ID FROM MEMBER WHERE AGE BETWEEN 30 AND 39 AND SEX = 'f';
...
WHERE
		MEMBER_ID IN (SELECT 
					  ...
					  FROM 
							MEMBER 
					  WHERE 
							AGE BETWEEN 30 AND 39 AND SEX = 'f');
